 ...
 * @format
 */
import { withAppBuildGradle, createRunOncePlugin, withProjectBuildGradle } from '@expo/config-plugins'; // Keeping the name, and version in sync with it's package.
...
export function setProjectRepositories(_config, buildGradle) {
...
export function setClassPath(_config, buildGradle) {
...
export default createRunOncePlugin( // The plugin to guard.
