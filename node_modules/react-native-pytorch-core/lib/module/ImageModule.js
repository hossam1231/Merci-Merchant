 ...
 * @format
 */
import { Image as RNImage, NativeModules, Platform } from 'react-native';
const {
  resolveAssetSource
} = RNImage;
const {
...
export const ImageUtil = {
  ...
  async fromBundle(imagePath) {
    ...
    if (Platform.OS === 'ios') {
      ...
      const ref = await ImageModule.fromBundle(source.uri);
      return wrapRef(ref);
    }
  },
  ...
  async fromImageData(imageData) {
    ...
    const ref = await ImageModule.fromImageData(imageDataRef);
    return wrapRef(ref);
  },
