...
var CSSFontUtils = _interopRequireWildcard(require("./utils/CSSFontUtils"));
...
const wrapRef = ref => {
  ...
  return {
    ...
    set fillStyle(value) {
      const color = (0, _reactNative.processColor)(value);
    ...
    drawImage(image, dx_sx, dy_sy, dWidth_sWidth = INVALID_VALUE_NULLABLE, dHeight_sHeight = INVALID_VALUE_NULLABLE, dx = INVALID_VALUE_NULLABLE, dy = INVALID_VALUE_NULLABLE, dWidth = INVALID_VALUE_NULLABLE, dHeight = INVALID_VALUE_NULLABLE) {
      CanvasRenderingContext2DModule.drawImage(ref, image, dx_sx, dy_sy, dWidth_sWidth, dHeight_sHeight, dx, dy, dWidth, dHeight);
    },
...
const PyTorchCoreCanvasView = (0, _reactNative.requireNativeComponent)('PyTorchCoreCanvasView');
/**
...
function Canvas({
  ...
  const handleContext2D = (0, React.useCallback)(event => {
    const {
      nativeEvent
    } = event;
    const {
